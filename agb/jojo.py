...
class JojoCog(agb.system.cogwheel.Cogwheel):
    ...
    async def _jojocharacter(self, interaction):
        endpoint = agb.system.cogwheel.getAPIEndpoint("jojo", "GET_CHARACTERS")
        ...
        image = agb.system.cogwheel.getAPIEndpoint("jojo", "GET_CHARACTER_IMAGE").format(character["image"])
